...
class ControlPanelGui(QMainWindow):
    def __init__(self, title, publisher: Panel_Publisher):
        ...
        self.stage_remaining_time.setText("420")
        ...
        self.text7.setText("red_outpost_hp")
        self.red_outpost_hp=QLineEdit(self)
        self.red_outpost_hp.setText("1000")

        self.text8=QLabel(self)
        self.text8.setText("blue_outpost_hp")
        self.blue_outpost_hp=QLineEdit(self)
        self.blue_outpost_hp.setText("1000")

        self.text9=QLabel(self)
        self.text9.setText("red_base_hp")
        self.red_base_hp=QLineEdit(self)
        self.red_base_hp.setText("1000")

        self.text10=QLabel(self)
        self.text10.setText("blue_base_hp")
        self.blue_base_hp=QLineEdit(self)
        self.blue_base_hp.setText("1000")
        ...
        self.main_layout.addWidget(self.red_outpost_hp)
        self.main_layout.addWidget(self.text8)
        self.main_layout.addWidget(self.blue_outpost_hp)
        self.main_layout.addWidget(self.text9)
        self.main_layout.addWidget(self.red_base_hp)
        self.main_layout.addWidget(self.text10)
        self.main_layout.addWidget(self.blue_base_hp)
    ...
    def PubGameStatusEvent(self,event):
        ...
        self.publisher.set_game_state(
            ...
            int(self.red_outpost_hp.text()),
            #uint16 blue_outpost_hp
            int(self.blue_outpost_hp.text()),
            #uint16 red_base_hp
            int(self.red_base_hp.text()),
            #uint16 blue_base_hp
            int(self.blue_base_hp.text())
        )

    def loop(self):
        while self.running:
            rclpy.spin_once(self.publisher, timeout_sec=0.1)
